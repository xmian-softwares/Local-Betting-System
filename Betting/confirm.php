...
<span style="float:right">Maximum Win: $25,000</span>Minimum Amount: $20</h5>
  <center><form method="post" action="update_amm.php?name=<?php echo $name?>&cata=<?php echo $cata?>">
    ...
    <center><h5 style="font-weight:bold;background:linear-gradient(to right,#DAA520,black,#DAA520);color:white;padding-top:1%;padding-bottom:1%;padding-right:3%;padding-left:3%">
    You Cant Bet On More Than 20 Games</h5></center>
