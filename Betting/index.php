  ...
  <div class="container-fluid">
    ...
    box-shadow:1px 1px 1px 1px gray;">
      <form method="post" action="dirc.php" style="margin-top:50px;"><br>
        <h3 style="margin:5%;color:blue;float:left">User :</h3><input type="text" name="name" style="width:50%;margin:5%;color:Blue;" placeholder="Enter Your Username" required><br><br>
